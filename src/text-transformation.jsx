...
{outputText && (
  <div className="flex justify-center w-full px-4 md:justify-end">
    <div className="border border-green-300 shadow-lg p-3 rounded-xl bg-blue-100 max-w-[500px] w-full md:w-auto">
